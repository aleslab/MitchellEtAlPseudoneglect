function setPlotDefaults( figHandle )
%setPlotDefaults Sets various matlab options for nicer plots. 
%setPlotDefaults( [figHandle] )
%
%Modified from the ptbCorgi toolbox. 
%
