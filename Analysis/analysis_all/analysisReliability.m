...
lmCI = (results.plotting.sessions.lm(:,7)/sqrt(780))*1.97;
...
% Extracting the CIs from the SDs
mlbCI = (results.plotting.sessions.mlb(:,7)/sqrt(780))*1.97;
...
% Extracting the CIs from the SDs
trbCI = (results.plotting.sessions.trb(:,7)/sqrt(780))*1.97;
